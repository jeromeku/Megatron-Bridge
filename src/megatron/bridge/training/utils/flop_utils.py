...
def _calculate_layer_counts(model_cfg: ModelProviderType) -> tuple[int, int, int]:
    """Calculate the number of attention, Mamba, and MLP layers for hybrid models."""
